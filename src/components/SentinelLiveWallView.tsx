...
import { Video, Maximize2, ExternalLink, RefreshCw, Shield } from 'lucide-react';
...
const SENTINEL_CAMERAS: SentinelCamera[] = [
  { id: '1',  number: 1,  name: 'Camera 1',  location: 'Chiman Bhai Bridge',                  status: 'live', codec: 'h264', container: 'mp4' },
  { id: '2',  number: 2,  name: 'Camera 2',  location: 'Janpath',                              status: 'live', codec: 'h264', container: 'mp4' },
  { id: '3',  number: 3,  name: 'Camera 3',  location: 'O.N.G.C. Office',                     status: 'live', codec: 'h264', container: 'mp4' },
  { id: '4',  number: 4,  name: 'Camera 4',  location: 'Paldi Circle',                        status: 'live', codec: 'h264', container: 'mp4' },
  { id: '5',  number: 5,  name: 'Camera 5',  location: 'Visat Teen Rasta',                    status: 'live', codec: 'h264', container: 'mp4' },
  { id: '6',  number: 6,  name: 'Camera 6',  location: 'Timbavadi Gate, Junagadh',            status: 'live', codec: 'avi',  container: 'avi' },
  { id: '7',  number: 7,  name: 'Camera 7',  location: 'Hero Showroom, Gir Somnath',          status: 'live', codec: 'h264', container: 'mp4' },
  { id: '8',  number: 8,  name: 'Camera 8',  location: 'Majewadi Gate, Junagadh',             status: 'live', codec: 'h264', container: 'mp4' },
  { id: '9',  number: 9,  name: 'Camera 9',  location: 'New Bypass Circle, Junagadh',         status: 'live', codec: 'h264', container: 'mp4' },
  { id: '10', number: 10, name: 'Camera 10', location: 'Char Chowk Road, Junagadh',           status: 'live', codec: 'h264', container: 'mp4' },
  { id: '11', number: 11, name: 'Camera 11', location: 'Dolatpara, Junagadh',                 status: 'live', codec: 'h264', container: 'mp4' },
  { id: '12', number: 12, name: 'Camera 12', location: 'Tri Mandir Adalaj Tollnaka',          status: 'live', codec: 'h264', container: 'mp4' },
  { id: '13', number: 13, name: 'Camera 13', location: 'CN Vidhyalaya',                       status: 'live', codec: 'h264', container: 'mkv' },
  { id: '14', number: 14, name: 'Camera 14', location: 'Delight',                             status: 'live', codec: 'h264', container: 'mkv' },
  { id: '15', number: 15, name: 'Camera 15', location: 'Suvidha Park',                        status: 'live', codec: 'h264', container: 'mkv' },
  { id: '16', number: 16, name: 'Camera 16', location: 'Visat P2',                            status: 'live', codec: 'h264', container: 'mkv' },
  { id: '17', number: 17, name: 'Camera 17', location: 'Rajkot Bus Port',                     status: 'live', codec: 'h264', container: 'mp4' },
  { id: '18', number: 18, name: 'Camera 18', location: 'Rajkot CCTV',                         status: 'live', codec: 'h264', container: 'mp4' },
  { id: '19', number: 19, name: 'Camera 19', location: 'Rajkot CCTV',                         status: 'live', codec: 'h264', container: 'mp4' },
  { id: '20', number: 20, name: 'Camera 20', location: 'Khaparia Gram Panchayat, Navsari',    status: 'live', codec: 'h264', container: 'mp4' },
  { id: '21', number: 21, name: 'Camera 21', location: 'Mohanpura',                           status: 'live', codec: 'h264', container: 'mp4' },
  { id: '22', number: 22, name: 'Camera 22', location: 'Patan Dethali Char Rasta',            status: 'live', codec: 'h264', container: 'mp4' },
  { id: '23', number: 23, name: 'Camera 23', location: 'BK Mervada Tran Rasta',               status: 'live', codec: 'avi',  container: 'avi' },
  { id: '24', number: 24, name: 'Camera 24', location: 'Kheram',                              status: 'live', codec: 'h264', container: 'mp4' },
  { id: '25', number: 25, name: 'Camera 25', location: 'Dehgam',                              status: 'live', codec: 'h264', container: 'mp4' },
  { id: '26', number: 26, name: 'Camera 26', location: 'Dhanori',                             status: 'live', codec: 'h264', container: 'mp4' },
  { id: '27', number: 27, name: 'Camera 27', location: 'Tankal',                              status: 'live', codec: 'h264', container: 'mp4' },
  { id: '28', number: 28, name: 'Camera 28', location: 'Bilimora — Site A',                   status: 'live', codec: 'h264', container: 'mp4' },
  { id: '29', number: 29, name: 'Camera 29', location: 'Bilimora — Site B',                   status: 'live', codec: 'h264', container: 'mp4' },
  { id: '30', number: 30, name: 'Camera 30', location: 'Bilimora — Site C',                   status: 'live', codec: 'h264', container: 'mp4' },
  { id: '31', number: 31, name: 'Camera 31', location: 'Gandhidham Rambaugh P2',              status: 'live', codec: 'h264', container: 'mp4' },
];

// Clean camera player embed with clipped controls & zero network errors
  ...
  return (
    <div className="relative bg-[#081325] rounded-xl border border-slate-800 overflow-hidden group flex flex-col shadow-lg">
      ...
      <div className="relative flex-1 min-h-0 bg-black overflow-hidden" style={{ height: 210 }}>
        ...
        {!isLoaded && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#091428] text-slate-400 z-10">
            ...
            <span className="text-[10px] font-mono font-bold text-slate-300">Loading Sentinel Live Stream…</span>
            <span className="text-[9px] text-slate-500 font-mono mt-0.5">{cam.location}</span>
          </div>
        )}

        {/* Sentinel Official Player Page Iframe — handles HLS, segment buffering, and avoids 500/206 errors */}
        <iframe
          src={`${SENTINEL_BASE}/camera/${encodeURIComponent(cam.id)}`}
          title={`${cam.name} - ${cam.location}`}
          className={`w-full border-0 relative z-1 transition-opacity duration-300 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}
      ...
      <div className="px-3 py-2 bg-[#0d1f3c] border-t border-slate-800 flex items-center justify-between flex-shrink-0">
        ...
        <span className="text-[9px] px-1.5 py-0.5 rounded bg-blue-950 text-blue-300 font-mono border border-blue-800 shrink-0 uppercase font-bold">
          {cam.codec}
        </span>
      </div>
    </div>
    ...
    <div className="space-y-4 select-none">
      ...
      <div className="bg-[#00253E] text-white p-4 sm:p-5 rounded-xl border border-[#00385C] shadow-md flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
        <div>
          <div className="flex items-center space-x-2 mb-1">
            ...
            <span className="text-slate-400 font-mono text-[11px]">Sentinel Gujarat Official Stream Player</span>
          </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-3.5 shadow-xs">
          ...
          <div className="text-xl font-black text-blue-700 font-mono mt-0.5">HLS Player</div>
          ...
          <div className="flex items-center justify-between mb-3 text-white">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">{fullscreenCam.location} • Sentinel Gujarat Official Stream</p>
              </div>
            </div>
            <button
