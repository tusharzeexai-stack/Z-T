...
export const Navigation: React.FC<NavigationProps> = ({
  ...
  const navItems: { id: NavTab; label: string; badge?: number; highlight?: boolean }[] = [
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`py-3 text-xs font-semibold tracking-normal transition-all relative whitespace-nowrap flex items-center space-x-1.5 ${
                  isActive
